// Within the member function, we can get access to the current instance using this even though the same function
// body is shared between all instances. The reason should be obvious from our earlier discussion on this and the
// calling context. It is because we call a function on some instance, in other words, instance.someMemberFunction().
